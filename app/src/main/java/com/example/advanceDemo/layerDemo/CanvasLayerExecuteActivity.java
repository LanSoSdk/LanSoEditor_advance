...
public class CanvasLayerExecuteActivity extends Activity {
        ...
        findViewById(R.id.id_video_edit_btn2).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (LanSongFileUtil.fileExist(dstPath)) {
                    DemoUtil.startPlayDstVideo(CanvasLayerExecuteActivity.this, dstPath);
                } else {
                    Toast.makeText(CanvasLayerExecuteActivity.this,
        ...
        autoExecute.setOnLanSongSDKCompletedListener(new OnLanSongSDKCompletedListener() {
            ...
            public void onLanSongSDKCompleted(String dstVideo) {
                ...
                if (LanSongFileUtil.fileExist(dstPath)) {
                    ...
                    DemoUtil.showDialog(CanvasLayerExecuteActivity.this, "转换错误,请查看log信息");
                }
            }
        });
