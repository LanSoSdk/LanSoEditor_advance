...
public class DrawPadAllExecute2 {
    ...
    public BitmapLayer addBitmapLayer(LSOAsset asset, long startTimeUs, long endTimeUs) {
        if (commonRunnable != null && setup()) {
    ...
    public BitmapLayer addBitmapLayer(LSOAsset asset) {
        if (commonRunnable != null && setup()) {
    ...
    public MVCacheLayer addMVLayer(LSOAsset asset) {
        if (commonRunnable != null && setup()) {
    ...
    public MVCacheLayer addMVLayer(LSOAsset asset, long startTimeUs, long endTimeUs, boolean mute) {
        if (commonRunnable != null && setup()) {
    ...
    public GifLayer addGifLayer(LSOAsset gifAsset, long startTimeUs, long endTimeUs) {
        if (commonRunnable != null && setup()) {
