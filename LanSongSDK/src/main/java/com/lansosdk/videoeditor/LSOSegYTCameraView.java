...
import com.lansosdk.box.LSOSegmentModule;
...
import com.lansosdk.box.LSOSegYTCameraRunnable;

public class LSOSegYTCameraView extends FrameLayout {

    private LSOSegYTCameraRunnable renderer;
    ...
    public LSOSegYTCameraView(Context context) {
        super(context);
        initVideoView(context);
    }

    public LSOSegYTCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVideoView(context);
    }

    public LSOSegYTCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVideoView(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LSOSegYTCameraView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public interface onViewAvailable {
        void viewAvailable(LSOSegYTCameraView v);
    }
     ...
     * @throws Exception
     */
    public void setSegmentModule(LSOSegmentModule asset){
        setup();
        if (renderer != null) {
            renderer.setSegmentModule(asset);
        }
    }
    /**
     ...
     *  清空所有的录制的视频
     */
    public void removeAllRecordVideo(){
        if(renderer!=null){
            renderer.removeAllRecordVideo();
        }
    }
    /**
     *
    ...
    private void setup() {
        if (mSurfaceTexture != null && renderer == null) {
            renderer = new LSOSegYTCameraRunnable(getContext(), compWidth, compHeight);
