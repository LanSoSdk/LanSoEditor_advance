...
//     */
//    public void addSpeedTimeRange(long startTimeUs, long endTimeUs, float speed) {
...
//     * @param timearray
//     */
//    public void addSpeedTimeRange(List<LSOTimeRange> timearray) {
...
//     * @param loopcnt 重复的次数;
//     */
//    public void addRepeatRange(long startUs, long endUs, int loopcnt) {
...
//    }
//
//    public void addRepeatRange(List<LSOTimeRange> list) {
...
//         */
//        if (timeStretchArray != null) {
//            drawPad.addSpeedTimeRange(timeStretchArray);
//        }
//
//        if (timeRepeatArray != null) {
//            drawPad.addRepeatRange(timeRepeatArray);
//        }
//
//        if (timeFreezeArray != null) {
...
//        if (bgMusicInfo != null) {
//
//            audioPad = new AudioPadRunnable(context, inputPath, !isMixBgMusic);
//            if (inputVideoVolume != 1.0f) {
//                audioPad.getMainAudioLayer().setVolume(inputVideoVolume);
//            }
//            /**
//             * 增加另一个音频;
//             */
...
//            subsource.setPreviewLooping(true);
//
//            /**
//             * 设置各种回调
//             */
...
//                }
//            });
//            audioPad.setOnAudioPadCompletedListener(new AudioPadRunnable.onAudioPadExecuteCompletedListener() {
//                @Override
